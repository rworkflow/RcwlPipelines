...
## The _R_ recipies and cwl scripts
...
range of Bioionformatics data analysis needs.
...
`cwlUpdate` everytime unless they want to use a tool/pipeline that is
...
pipeline. This pipeline covers RNAseq reads quality summary by
...
tools installed, neither support the docker runtime, here we use some
